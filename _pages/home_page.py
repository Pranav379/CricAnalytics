...
with col_left:
    st.markdown(
        ...
        <div style="display: flex; justify-content: center; align-items: center; height: 100%;">
            <img src="data:image/png;base64,{encoded_left}" style="max-width: 150px;">
        </div>
        """,
...
with col_right:
    st.markdown(
        f"""
        <div style="display: flex; justify-content: center; align-items: center; height: 100%;">
            <img src="data:image/png;base64,{encoded_right}" style="max-width: 150px;">
        </div>
        """,
        unsafe_allow_html=True
    )
...
st.markdown(
    ...
    <div style="text-align: center; margin-top: 20px;">
        <img src="data:image/png;base64,{encoded_center}" style="max-width: 200px;">
    </div>
    """,
    unsafe_allow_html=True
)
