...
with col_left:
    st.markdown(
        ...
        <div style="
            ...
            align-items: center;
            ">
            <img src="data:image/jpeg;base64,{encoded_left}" style="height: 90vh; width: auto; max-width: 100%;">
        </div>
        """,
...
with col_mid:
    # Text block remains same, no vertical stretching
...
with col_right:
    st.markdown(
        ...
        <div style="
            ...
            align-items: center;
            ">
            <img src="data:image/jpeg;base64,{encoded_right}" style="height: 90vh; width: auto; max-width: 100%;">
        </div>
        """,
        unsafe_allow_html=True,
    )

# Centered image below the top section (optional height control)
st.markdown(
    f"""
